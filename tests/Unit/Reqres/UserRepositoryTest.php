...
beforeEach(function () {
    ...
    $this->reqres = new Reqres($this->client);
});
...
it('creates a new user', function () {
    ...
    $response = $this->reqres->createUser($userDTO);
...
it('fetches a single user by ID', function () {
    ...
    $user = $this->reqres->getUserById(2);
...
it('fetches all users with pagination', function () {
    ...
    $response = $this->reqres->getAllUsers();
...
it('fetches all users with pagination no data', function () {
    ...
    $response = $this->reqres->getAllUsers(1);
